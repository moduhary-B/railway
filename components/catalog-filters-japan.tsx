...
export function CatalogFiltersJapan({
  filters,
  onFiltersChange,
  brands,
  models,
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Input
            ...
            onFocus={() => {
              // Убеждаемся, что фокус на поле мощности не влияет на поля пробега
              if (focusedField && focusedField.startsWith('mileage')) {
                setFocusedField(null);
              }
            }}
  ...
  ), [tempFilters.powerMin, tempFilters.powerMax, focusedField]);
