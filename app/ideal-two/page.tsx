...
export default function Home() {
  ...
  return (
    <div className="ideal2 flex flex-col min-h-screen bg-gradient-to-b from-[#0a0f1a] via-[#0e1720] to-[#1a2332] overflow-x-clip w-full">
      ...
      <section id="hero" className="relative pt-16 pb-20 md:pt-16 md:pb-32 lg:pt-10 lg:pb-8 overflow-hidden min-h-[90vh] flex items-center scroll-mt-24">
        {/* Video Placeholder */}
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
              <div className="text-center lg:text-left">
                ...
                >
                  ...
                  <span className="block mt-1 text-white/90 text-[clamp(1.5rem,6.5vw,1.875rem)] md:text-5xl lg:text-6xl">
                ...
                {/* Кнопка "Оставить заявку" — sweep-градиент, translateY hover, тёплая тень */}
                <motion.div
                ...
                <div className="max-w-xl mx-auto lg:mx-0">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <a
                      ...
                      className="group w-full sm:w-auto min-h-[48px] inline-flex items-center justify-center gap-2 rounded-md border border-[#7357ff]/35 bg-[#7357ff]/10 px-4 text-sm font-medium text-white/90 hover:bg-[#7357ff]/20 hover:border-[#8d77ff]/60 hover:text-white transition-all focus-lux"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 sm:flex-none min-h-[48px] inline-flex items-center justify-center gap-2 rounded-md border border-[#25D366]/30 bg-[#25D366]/[0.07] px-4 text-sm font-medium text-white/85 hover:bg-[#25D366]/15 hover:border-[#25D366]/50 hover:text-white transition-all focus-lux"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 sm:flex-none min-h-[48px] inline-flex items-center justify-center gap-2 rounded-md border border-[#26A5E4]/30 bg-[#26A5E4]/[0.07] px-4 text-sm font-medium text-white/85 hover:bg-[#26A5E4]/15 hover:border-[#26A5E4]/50 hover:text-white transition-all focus-lux"
                    >
            ...
            <div className="mt-10 pt-5 border-t border-[#c9a86e]/20">
              ...
              >
                ...
                <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0 } }}>
                  ...
                  >
                    <div className="w-10 h-10 md:w-16 md:h-16 rounded-full overflow-hidden bg-white shadow-xl group-hover:shadow-2xl transition-all duration-300 transform group-hover:scale-110 ring-2 ring-white/60">
                      <Image
                        src="/icons/flag-korea.svg"
