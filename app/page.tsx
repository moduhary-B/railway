          ...
          <div className="flex items-center justify-between py-4 px-8">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              <a
                ...
                className="text-[#c9a86e] font-semibold text-lg hover:text-[#d4b876] transition-colors flex items-center gap-2"
              >
                <div className="w-10 h-10 rounded-full bg-[#1a2332] flex items-center justify-center">
                  <Phone className="w-5 h-5 text-[#c9a86e]" />
                </div>
                <div>
                  <span className="block text-sm text-white/70">Звоните нам</span>
                  +7 (995) 868−97−68
                </div>
              </a>
              <div className="flex items-center space-x-4 pl-2">
                <a href="https://t.me/orientauto_ru" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-[#c9a86e] transition-colors">
                ...
                <a href="https://wa.me/79958689768" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-[#c9a86e] transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://www.youtube.com/@orientauto_ru" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-[#c9a86e] transition-colors">
                  <Youtube className="w-6 h-6" />
                </a>
                <a href="https://www.instagram.com/orientauto.ru?igsh=MTl0ZXk4ZDZ4YTB6aw==" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-[#c9a86e] transition-colors">
                ...
                {/*
                <a
                    href="https://tlgg.ru/@al_orientauto"
                ...
                <div className="container mx-auto px-4 py-20 pb-8">
                  ...
                  <div className="mt-12 space-y-6">
                    ...
                    <div className="flex items-center gap-6 pt-4">
                      ...
                      <a href="https://instagram.com/orientauto" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-[#c9a86e] transition-colors">
                        <Instagram className="w-6 h-6" />
                      </a>
                    </div>
                  </div>
